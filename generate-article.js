...
const topicData = {
  ...
  toto: [
      ...
      {
          title: "История дня: Хроники Тото",
          prompt: "Поведай о том, как Тото, пытаясь поймать солнечного зайчика, случайно наткнулся на забытую в саду лейку. Дождь застал его врасплох, и он спрятался в ней, пока хозяйка не нашла его. Опиши, как дождь и его последствия повлияли на это событие."
      },
      {
          title: "История дня: Хроники Тото",
...
— Погода и история: ${mythologyTopic.prompt}
— Погода и животные: ${animalsTopic.prompt}
— История дня: Хроники Тото: ${totoTopic.prompt}
