...
— Погода и история: Расскажи о каком-то интересном историческом событии, на которое повлияла погода. Например, о том, как туман, ветер или мороз изменили ход битвы или судьбу экспедиции.
— Метеорологический ликбез: просто о сложном: Объясни, как и почему образуются разные виды облаков — например, почему кучевые облака похожи на вату, а перистые — на тонкие перья. Расскажи, о чем они могут "говорить" наблюдателю.
...
— Фотопрогноз от читателей: Напиши короткий призыв к читателям делиться своими фотографиями погоды, чтобы они могли попасть в следующий выпуск.
